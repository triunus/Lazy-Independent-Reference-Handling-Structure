...
{
    public class PlayerUnitDBHandler : IStaticReferenceHandler
    {
        private string PlayerUnitDataSOPath = "ScriptableObject/PlayerSystem/PlayerUnitResourceDataSO";

        public bool TryLoadScriptableObject(out UnitResourceDataSO unitResourceDataSO)
        {
            unitResourceDataSO = Resources.Load<UnitResourceDataSO>(this.PlayerUnitDataSOPath);
